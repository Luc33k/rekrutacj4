  ...
  <body class="d-flex h-100 text-center text-white bg-dark">
    ...
    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
      ...
      <main class="form-changepass">
        ...
        <form  method="POST" name= "f2" onsubmit = "return validation()" action="./authentication.php">
            ...
            <div class="form-floating">
                <input type="password" class="form-control" id="pass_new1" name="pass_new1" placeholder="Podaj nowe hasło">
                <label for="pass_new1">Podaj nowe hasło</label>
            </div>
            <div class="form-floating">
                <input type="password" class="form-control" id="pass_new2" name="pass_new2" placeholder="Powtórz nowe hasło">
                <label for="pass_new2">Powtórz nowe hasło</label>
            </div>

            
            <button class="w-100 btn btn-lg btn-primary" type="submit" id="button_submit" name="button_submit">Sign in</button>
